...
from src.models.train_lgbm import align_categories, train_lgbm
...
def fit_xgb_model(
    ...
    model = Ridge(alpha=2.0, random_state=43)
...
def fit_final_lgb_model(train_df: pd.DataFrame, feature_cols: list[str], n_estimators: int):
...
def fit_final_xgb_model(train_df: pd.DataFrame, feature_cols: list[str], n_estimators: int):
